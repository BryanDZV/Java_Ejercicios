...
public class CuatroEnRaya {
	...
	public static void main(String[] args) {
		...
		recTablero=new Rectangulo(esquinaSupIzq,new Punto(esquinaSupIzq.getX()+tablero[0].length*TAM_CASILLA,esquinaSupIzq.getY()-tablero.length*TAM_CASILLA));
	...
	private static void introducirFicha(int jugador, int columna) {
		...
		if (columna<0 || columna>tablero[0].length-1)
			throw new IllegalArgumentException("La columna debe estar entre 0 y "+(tablero[0].length-1));
