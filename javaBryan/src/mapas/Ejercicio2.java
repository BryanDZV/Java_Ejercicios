...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		for (String elemento : diccEspIng.keySet()) {
			System.out.println(elemento+" "+diccEspIng.get(palabraIntro));
...
//		for (String elementoClave : diccEspIng.keySet()) {
//			Pareja elementoValor=diccEspIng.get();
//			if (!l.contains(elementoValor)) {
//				l.add(elementoValor);
//				
//			}
//			
