...
public class AppPersonas {
	...
	public static void main(String[] args) {
		...
		Personas h;
		// a la variable le asignas=CREAR OBJETO con (new clase llamada)envio parametros
		// bryan zepeda....mismo orden de constructor
		...
		Personas[] pueblo1 = { new Personas("luquitas", "choto", "femenino", 9, true),
		...
		for (int i = 0; i < pueblo1.length; i++) {
			// h[i]=new Personas("luquitas","choto","femenino",9,true);
